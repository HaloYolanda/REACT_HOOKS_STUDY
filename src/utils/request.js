...
export default function request(url, option) {
  ...
  // BUILD_ENV 当前环境 test: 测试, pre: 预生产, pro: 生产
  let xCurrentEnv = '';
  if (BUILD_ENV === 'pre') {
    xCurrentEnv = 'Blue';
  } else if (BUILD_ENV === 'pro') {
    xCurrentEnv = 'Green';
  }
  ...
  newOptions.headers = {
    ...
    'x-client': 'pc-back',
    'x-current-env': xCurrentEnv,
    ...newOptions.headers,
  };

  if (options.expirys === undefined) {
    // 默认不走缓存
    options.expirys = false;
  }
  if (
